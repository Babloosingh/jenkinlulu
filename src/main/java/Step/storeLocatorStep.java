...
//	 
	...
	// public static final String CLICKCHECK_STORELOCATOR
	// ="com.lulu.commerce:id/btnStoreLocator";
	// public static final String SELCET_COUNTRY
	// ="com.lulu.commerce:id/btnCountryClick";
	// public static final String CLICK_COUNTRY_KSA
	// ="//*[@class=\"android.widget.TextView\"][@text=\"KSA\"]";
	// public static final String SELCET_CITY ="com.lulu.commerce:id/btnCityClick";
	// public static final String CLICK_CITY_JEDDSH
	// ="//*[@class=\"android.widget.TextView\"][@text=\"Jeddah\"]";
	...
	// public static final String
	// CLICK_CANCEL_BUTTON="com.lulu.commerce:id/btnBack";
